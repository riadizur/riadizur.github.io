...
class Referensim extends CI_Model {
	...
	public function get_siujk_detil_list()
  {
	...
	{
		$query = $this->db->query("SELECT id, klasifikasi as isi, 'siujk' as jenis FROM tl_siujk_klasifikasi");
		return $idsiujk = $query->result();
	}
	...
	{
		$query = $this->db->query("SELECT id, kategori as isi, 'siup' as jenis FROM tl_kbli_kategori");
	...
	{
		$this->db->select("id_vd, kode_siujk, bidang_siujk");
