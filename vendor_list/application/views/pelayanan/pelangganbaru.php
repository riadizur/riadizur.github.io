			<div class="page-head">
				<div class="page-title">
					<h1>Pelanggan Baru <small>Register Customer</small></h1>
				</div>
				...
				<div class="col-md-12">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Entry Pelanggan Baru
							</div>
							<div class="tools">
								...
								<div class="tab-pane fade active in" id="tab_1_1">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												<div class="btn-group">
													<a class="btn green" onclick="add_cust()" data-toggle="modal">Tambah Data </a>
												</div>
											</div>
										</div>
									</div>
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" name="prov_cust2" class="form-control input-sm" placeholder=" " >
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" name="kota_cust2" class="form-control input-sm" placeholder=" " >
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" name="kec_cust2" class="form-control input-sm" placeholder=" " >
