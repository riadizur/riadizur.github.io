...
<table width=100%>
	<tr>
		<td align="center" style="font-size: 18px">Tarif / Daya : <b><?php echo $data_agenda['TARIF'] ?> / <?php echo number_format($data_agenda['DAYA'],0) ?> VA</b></td>
	</tr>	  
</table>
<br>
<table width=100%>
...
<table width=100%>
	<tr>
		<td align="center" style="font-size: 18px">Tarif / Daya : <b><?php echo $data_agenda['TARIF'] ?> / <?php echo $data_agenda['DAYA'] ?> VA</b></td>
	</tr>	  
</table>
<br>
<table width=100%>
...
<table width=100% class="font_standar">
	<tr>
		<td align="justify">PARA PIHAK sepakat untuk mengadakan Perjanjian Pengelolaan Pelayanan Instalasi Listrik pada nama langganan <b><?php echo $data_agenda['NAMA_LANG'] ?></b> dengan daya <b><?php echo $data_agenda['DAYA'] ?> VA, <?php echo $data_tarif['KLMPK_PHASA'] ?>, <?php echo $data_tarif['KLMPK_TEGANGAN'] ?>, Frekuensi 50 Hz , tarif  <?php echo $data_agenda['TARIF'] ?></b>, dengan ketentuan-ketentuan sebagaimana diuraikan dalam pasal–pasal berikut  :</td>
	</tr>	  
</table>
...
<table width=100% class="font_standar">
	<tr>
		<td valign="top">1.</td>
		<td align="justify">PIHAK PERTAMA menyalurkan tenaga listrik ke instalasi listrik milik PIHAK KEDUA dengan daya <b><?php echo $data_agenda['DAYA'] ?> VA, <?php echo $data_tarif['KLMPK_PHASA'] ?>, <?php echo $data_tarif['KLMPK_TEGANGAN'] ?></b> dengan <b>kualitas tegangan +5 % dan –10% , Frekuensi 50 Hz</b> dengan kualitas frekuensi  <b>+/- 1% Cos phi 0,85 , tarif  <?php echo $data_agenda['TARIF'] ?></b>.</td>
	</tr>
	<tr>
		<td valign="top">2.</td>
...
<table width=100% class="font_standar">
	<tr>
		<td valign="top">1.</td>
		<td align="justify">Biaya Penyambungan (BP) untuk daya  <b><?php echo number_format($data_agenda['DAYA']) ?> VA</b> adalah sebesar <b>Rp. <?php echo number_format($data_agenda['TOTAL_BIAYA'],0) ?>,-</b>.</td>
	</tr>
	<tr>
		<td valign="top">2.</td>
		<td align="justify">Uang Jaminan Langganan (UJL) untuk daya <b><?php echo number_format($data_agenda['DAYA']) ?> VA</b> adalah sebesar <b>Rp. <?php echo number_format($data_agenda['RP_UJL'],0) ?>,-</b> mengingat metode pembayaran telah menggunakan sistem autodebet.</td>
	</tr>
...
<table width=100% class="font_standar">
	<tr>
		<td valign="top">1.</td>
		<td align="justify">Apabila pemakaian dibawah atau sama dengan <b><?php echo $data_jam['NILAI_JAMNYALA'] ?>jam</b> nyala dari daya kontrak maka diberlakukan Energi minimum (Emin) : <b>(<?php echo $data_jam['NILAI_JAMNYALA'] ?> Jam x <?php echo number_format($data_agenda['DAYA']) ?> VA : 1000)</b>.   
Energi minimum pada langganan ini sebesar <b><?php echo number_format(($data_jam['NILAI_JAMNYALA'] * ($data_agenda['DAYA'] / 1000)))  ?> kWh/Bulan</b>. Selisih kWh Total (penjumlahan kWh LWBP dan kWh WBP) dengan kWh Emin ditambahkan pada kWh LWBP.</td>
	</tr>
	<tr>
		<td valign="top">2.</td>
