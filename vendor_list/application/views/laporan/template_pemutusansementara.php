			...
			<td>
				...
				<tr>
					<td class="wrapper last">
						<h4>SURAT PEMBERITAHUAN PEMUTUSAN SEMENTARA</h4>
						<p>
							 Pelanggan Yth.
						</p>
						<!-- BEGIN: Note Panel -->
						...
						<tr>
							<td class="panel">Kami informasikan bahwa anda telah melewati batas akhir waktu pembayaran tagihan rekening listrik bulan.
								Tim kami akan segera melakukan pemutusan.</td>
							<td class="panel"></td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						</table>
						<p>Mohon untuk segera melakukan pelunasan tagihan rekening listrik dimaksud.</p>
						<p>Terima Kasih</p>
						<!-- END: Note Panel -->
					</td>
				</tr>
				...
				<tr>
					<td class="wrapper">
						...
						<tr>
							<td>
								<img src="../../assets/img/templateemail.jpg" class="ie10-responsive">
							</td>
							<td class="expander">
							</td>
						</tr>
