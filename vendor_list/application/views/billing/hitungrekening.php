...
function hitung(){
	...
	$.ajax({
		url: '<?php echo base_url(); ?>/index.php/billing/proseshitungrekening/',
		type: "POST",
		dataType:"json",
		success:function(datas){
			setTimeout(function(){$('#small').modal('hide')},1000);
			$('#BtnHitung').text('Proses Hitung Rekening'); 
			$('#BtnHitung').attr('disabled',false);
			document.getElementById("sukses").innerHTML = "Proses Hitung Rekening Berhasil!!";
		...
		error: function (jqXHR, textStatus, errorThrown)
        {
			...
			$('#BtnHitung').text('Proses Hitung Rekening'); 
			$('#BtnHitung').attr('disabled',false);
			document.getElementById("sukses").innerHTML = "Proses Hitung Rekening Gagal!!";
			table.ajax.reload(null,false);
        }
	});
}
			...
			<div class="page-head">
				<div class="page-title">
					<h1>Hitung Rekening <small>Billing</small></h1>
				</div>
				...
				<div class="col-md-12">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Hitung Rekening
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-toolbar">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a class="btn green" data-toggle="modal" onclick="hitung()" id="BtnHitung" >Proses Hitung Rekening</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row ">
				<div class="col-md-12">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Hasil Perhitungan Rekening
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-toolbar">
...
$(document).ready(function() {
    table = $('#table').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('billing/hitung_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
