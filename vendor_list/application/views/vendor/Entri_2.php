		...
		$.ajax({
				...
				success: function(data)
				{
					if(data.status)
					{
						...
						cell2.innerHTML = b;
						cell3.innerHTML = c;
						cell4.innerHTML = "<a class='btn btn-sm red text-center' onclick='del_siup(this)' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a> ";
...
function add_siujk()
{
	...
	if (id_vd != '' && kode != '') {
		$.ajax({
				url : "<?php echo site_url('vendor/list_siujk_insert')?>/"+id_vd+"/"+kode,
				type: "POST",
				dataType: "JSON",
				success: function(data)
				{
					if(data.status)
					{
						...
						cell2.innerHTML = b;
						cell3.innerHTML = c;
						cell4.innerHTML = "<a class='btn btn-sm red text-center' onclick='del_siujk(this)' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a> ";
		...
		$.ajax({
				...
				success: function(data)
				{
					if(data.status)
					{
						...
						var cell4 = row.insertCell(3);
						cell1.innerHTML = no;
						cell2.innerHTML = 'SIU-'+data.nomor;
						cell3.innerHTML = isi;
						cell4.innerHTML = "<a class='btn btn-sm red text-center' onclick='del_siu(this)' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a> ";
						$("#siu_input").val('');
					}
					else
					{
