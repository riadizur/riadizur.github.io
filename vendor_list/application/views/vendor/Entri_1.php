															...
															<div class="tab-content">
																		...
																		<div class="form-group">
																			...
																			<div class="col-md-9">
																				<div class="input-group">
																					...
																					<select class="form-control select2me" style="width:100%;"  id="list_siup_all" name="list_siup_all" data-placeholder="-Pilih-">
																						<option value="">-Pilih-</option>
																						<?php
																						foreach ($list_kbli as $r)
																						{
																...
																<div class="tab-pane" id="tab_1_1_2">
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			<label class="col-md-4 control-label align-left">Grade</label>
																			<div class="col-md-8">
																				<select class="form-control input-sm" id="grade_siujk" name="grade_siujk" >
																					<option value="">-Pilih-</option>
																					<?php
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="col-md-3 control-label align-left">Pilih Klasifikasi</label>
																			<div class="col-md-9">
																				<div class="input-group">
																					<span class="input-group-btn">
																						<a type="button" id="btnAddsiujk" onclick="add_siujk()" class="btn btn-sm purple"><i class="glyphicon glyphicon-plus" title="Tambah Klasifikasi"></i></a>
																					</span>
																					<select class="form-control select2me" style="width:100%;"  id="list_siujk_all" name="list_siujk_all" data-placeholder="-Pilih-">
																						<option value="">-Pilih-</option>
																						<?php
																						foreach ($list_siujk as $r)
																						{
																							echo "<option value ='".$r->id."'>".$r->isi."</option>";
																						}
																						?>
																...
																<div class="tab-pane" id="tab_1_1_3">
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			<div class="col-md-12">
																				<a type="button" id="btnAddsiujk" onclick="add_siu()" class="btn btn-sm purple"><i class="glyphicon glyphicon-plus" title="Tambah Klasifikasi"></i> Tambah Klasifikasi</a>
																			</div>
																		</div>
...
function add_siup()
{
	...
	if (b == '') {
		...
		var kolom_2 = "<td>"+c+"</td>";
		var kolom_3 = "<td><a class='btn btn-sm red' onclick='return removeElement(\""+tabel+"\",\""+ urut_siup +"\")' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a></td>";
		var kolom_4 = '<input type="hidden" value="'+b+'" name="list_siup_'+urut_siup+'" />';
		addElement(tabel, urut_siup, kolom_1, kolom_2, kolom_3, kolom_4);
...
function add_siujk()
{
	...
	if (b == '') {
		...
		var kolom_2 = "<td>"+c+"</td>";
		var kolom_3 = "<td><a class='btn btn-sm red' onclick='return removeElement(\""+tabel+"\",\""+ urut_siujk +"\")' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a></td>";
		var kolom_4 = '<input type="hidden" value="'+b+'" name="list_siujk_'+urut_siujk+'" />';
		addElement(tabel, urut_siujk, kolom_1, kolom_2, kolom_3, kolom_4);
...
function add_siu()
{
	...
	var kolom_2 = '<td><input type="text" name="bidang_siu_'+urut_siu+'" class="form-control input-sm" placeholder=" " required /></td>';
	var kolom_3 = "<td><a class='btn btn-sm red' onclick='return removeElement(\""+tabel+"\",\""+ urut_siu +"\")' title='Hapus dari list'><i class='glyphicon glyphicon-minus'></i></a></td>";
	var kolom_4 = '';
	addElement(tabel, urut_siu, kolom_1, kolom_2, kolom_3, kolom_4);
...
function edit_vendor(id_cari)
{
	...
	$.ajax({
		...
		success: function(datas)
		{
			...
			$("#file_domisili").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_domisili+'">'+datas.file_domisili+'</a>'));

			$("#no_akta_pendirian").val(datas.no_akta_pendirian);
			$("#tgl_akta_pendirian").val(datas.tgl_akta_pendirian);
			$("#file_akta_pendirian").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_akta_pendirian+'">'+datas.file_akta_pendirian+'</a>'));
			...
			$("#file_akta_perubahan").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_akta_perubahan+'">'+datas.file_akta_perubahan+'</a>'));

			$("#no_npwp").val(datas.no_npwp);
			$("#tgl_npwp").val(datas.tgl_npwp);
			$("#file_npwp").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_npwp+'">'+datas.file_npwp+'</a>'));

			$("#no_pkp").val(datas.no_pkp);
			$("#tgl_pkp").val(datas.tgl_pkp);
			$("#file_pkp").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_pkp+'">'+datas.file_pkp+'</a>'));

			$("#no_tdp").val(datas.no_tdp);
			$("#tgl_tdp").val(datas.tgl_tdp);
			$("#tgl_exp_tdp").val(datas.tgl_exp_tdp);
			$("#file_tdp").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_tdp+'">'+datas.file_tdp+'</a>'));
			...
			$("#file_siup").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_siup+'">'+datas.file_siup+'</a>'));
			...
			$("#file_siujk").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_siujk+'">'+datas.file_siujk+'</a>'));
			...
			$("#file_siu").next().append($('<a href="<?php echo base_url(); ?>upload/'+datas.file_siu+'">'+datas.file_siu+'</a>'));
