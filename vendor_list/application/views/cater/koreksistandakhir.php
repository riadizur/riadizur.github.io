													...
													<tbody>
														<tr>
															...
															<td>
																...
																<input type="hidden" id="tgl_baca_akhirbefore" name="tgl_baca_akhirbefore" class="form-control datepicker" placeholder=" " >
															</td>
														</tr>
														<tr>
															<td class="active">
															...
															<td>
																...
																<input type="hidden" id="stand_psg_lwbpbefore" name="stand_psg_lwbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_akhir_lwbp" name="stand_akhir_lwbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_akhir_lwbpbefore" name="stand_akhir_lwbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
														</tr>
														<tr>
															<td class="active">
															...
															<td>
																...
																<input type="hidden" id="stand_psg_wbpbefore" name="stand_psg_wbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_akhir_wbp" name="stand_akhir_wbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_akhir_wbpbefore" name="stand_akhir_wbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
														</tr>
														<tr>
															<td class="active">
															...
															<td>
																...
																<input type="hidden" id="stand_psg_kvarhbefore" name="stand_psg_kvarhbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																...
																<input type="hidden" id="stand_akhir_kvarhbefore" name="stand_akhir_kvarhbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
														</tr>
													</tbody>
												</table>
