...
function cari(){
	...
	var baseUrl = '<?php echo base_url(); ?>index.php/cater/carilang/'+carix;
		$.ajax({
			url: baseUrl,
			dataType: 'json',
			success: function(datas){
				var agd = $.map(datas, function (obj) {
					...
					$("#pemlwbp_cater").val(obj.PEMLWBP_CATER);
					$("#pemwbp_cater").val(obj.PEMWBP_CATER);
					$("#pemkvarh_cater").val(obj.PEMKVARH_CATER);
				});
			},
												...
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<tr>
															...
															<td>
																<input type="text" id="tgl_baca_awal" name="tgl_baca_awal" class="form-control datepicker" placeholder=" " >
																<input type="hidden" id="tgl_baca_awalbefore" name="tgl_baca_awalbefore" class="form-control datepicker" placeholder=" " >
															</td>
															<td>
																&nbsp;
															</td>
															...
															<td>
																<input type="text" id="tgl_baca_akhir" name="tgl_baca_akhir" class="form-control datepicker" placeholder=" " readonly>
														...
														<tr>
															...
															<td>
																<input type="text" id="stand_awal_lwbp" name="stand_awal_lwbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_awal_lwbpbefore" name="stand_awal_lwbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_bkr_lwbp" name="stand_bkr_lwbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_bkr_lwbpbefore" name="stand_bkr_lwbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_psg_lwbp" name="stand_psg_lwbp" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															...
															<td>
																<input type="text" id="stand_akhir_lwbp" name="stand_akhir_lwbp" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
														...
														<tr>
															...
															<td>
																<input type="text" id="stand_awal_wbp" name="stand_awal_wbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_awal_wbpbefore" name="stand_awal_wbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_bkr_wbp" name="stand_bkr_wbp" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_bkr_wbpbefore" name="stand_bkr_wbpbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_psg_wbp" name="stand_psg_wbp" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															...
															<td>
																<input type="text" id="stand_akhir_wbp" name="stand_akhir_wbp" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
														...
														<tr>
															...
															<td>
																<input type="text" id="stand_awal_kvarh" name="stand_awal_kvarh" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_awal_kvarhbefore" name="stand_awal_kvarhbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_bkr_kvarh" name="stand_bkr_kvarh" class="form-control input-sm" style="text-align:right;" placeholder=" " >
																<input type="hidden" id="stand_bkr_kvarhbefore" name="stand_bkr_kvarhbefore" class="form-control input-sm" style="text-align:right;" placeholder=" " >
															</td>
															<td>
																<input type="text" id="stand_psg_kvarh" name="stand_psg_kvarh" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															...
															<td>
																<input type="text" id="stand_akhir_kvarh" name="stand_akhir_kvarh" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
												...
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<tr>
															...
															<td>
																<input type="text" id="pemlwbp_cater" name="pemlwbp_cater" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															</td>
														...
														<tr>
															...
															<td>
																<input type="text" id="pemwbp_cater" name="pemwbp_cater" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															</td>
														...
														<tr>
															...
															<td>
																<input type="text" id="pemkvarh_cater" name="pemkvarh_cater" class="form-control input-sm" style="text-align:right;" placeholder=" " readonly>
															</td>
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
							...
							<div class="modal-body">
								 <label>APAKAH ANDA YAKIN AKAN MELAKUKAN KOREKSI STAND ?? BERIKAN ALASANMU</label>
