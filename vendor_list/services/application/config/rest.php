...
|
*/
$config['rest_realm'] = 'EDII SERVICES API';
...
|
*/
$config['rest_valid_logins'] = array('admin' => '4p1cm0s');
...
|
| 127.0.0.1 and 0.0.0.0 are allowed by default.103.29.187.154
|
*/
$config['rest_ip_whitelist'] = ''; //'127.0.0.1,192.168.8.33,192.168.8.56,192.168.8.37,10.1.6.144';
...
|
*/
$config['rest_ip_blacklist'] = '';#192.168.8.5,192.168.8.24
