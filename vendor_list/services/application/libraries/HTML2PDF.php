...
if (!defined('__CLASS_HTML2PDF__')) {
	...
	include_once(APPPATH . 'libraries/html2pdf/_class/exception.class.php'); 
	include_once(APPPATH . 'libraries/html2pdf/_class/locale.class.php'); 
	include_once(APPPATH . 'libraries/html2pdf/_class/myPdf.class.php'); 
	include_once(APPPATH . 'libraries/html2pdf/_class/parsingHtml.class.php'); 
	include_once(APPPATH . 'libraries/html2pdf/_class/parsingCss.class.php'); 
