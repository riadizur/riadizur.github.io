	...
	$.ajax({
		...
		success: function(datas) {
			...
			$.map(datas, function(obj) {
				...
				data+='</div>';
				data+='<div id="kec" val="'+obj.kec+'"></div>';
				data+='<div id="kab" val="'+obj.kab+'"></div>';
				data+='<div id="prov" val="'+obj.prov+'"></div>';
				data+='<div id="no_kontrak" val="'+obj.no_kontrak+'"></div>';
				data+='<div>';
				data+='<hr/>';
